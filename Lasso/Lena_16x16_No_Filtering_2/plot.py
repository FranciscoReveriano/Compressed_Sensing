...
filter_Lena_Mask_20 = medianFilter(Lena_Mask_20, dimension, P,Q)
filter_Lena_Mask_30 = medianFilter(Lena_Mask_30, dimension, P,Q)
filter_Lena_Mask_40 = medianFilter(Lena_Mask_40, dimension, P,Q)
...
def plot_filter():
    ...
    # Sample = 20
    ax_3.set_title("Sample = 20")
    ax_3.imshow(filter_Lena_Mask_20)
    # Sample = 30
    ax_4.set_title("Sample = 30")
    ax_4.imshow(filter_Lena_Mask_30)
    # Sample = 40
    ax_5.set_title("Sample = 40")
    ax_5.imshow(filter_Lena_Mask_40)
    # Sample 50
    ax_6.set_title("Sample = 50")
    ax_6.imshow(filter_Lena_Mask_50)
    title = "Lena: (Block Size = 16 x 16) & (Filtering) & (Optimal Lambda)"
    fig.suptitle(title)
    plt.savefig("/home/franciscoAML/Documents/Compressed_Sensing/Lena_16x16_No_Filtering_2/Lena_16x16_Filtering.png")
    plt.show()
    ...
    print("Sample 20:", mean_squared_error(original_image, filter_Lena_Mask_20))
    print("Sample 30:", mean_squared_error(original_image, filter_Lena_Mask_30))
    print("Sample 40:", mean_squared_error(original_image, filter_Lena_Mask_40))
    print("Sample 50:", mean_squared_error(original_image, filter_Lena_Mask_50))
